...
if(/AppleWebKit.*Mobile/i.test(ua) || (/MIDP|SymbianOS|NOKIA|SAMSUNG|LG|NEC|TCL|Alcatel|BIRD|DBTEL|Dopod|PHILIPS|HAIER|LENOVO|MOT-|Nokia|SonyEricsson|SIE-|Amoi|ZTE/.test(ua))){}else if(top.location.href == window.location.href){
	$("body").addClass("ty-pc");
	$("<link>")
    .attr({ rel: "stylesheet",
        type: "text/css",
        href: "/Public/Home/css/ty_pc.css"
    })
    .appendTo("head");
	$.getScript("/Public/Home/js/index_pc.js");
}
if(/(iPhone|iPad|iPod|iOS)/i.test(ua)){
	$("body").addClass("ty-ios");
}
if(ua.indexOf("Android") >= 0){
	$("body").addClass("ty-android");
	var androidversion = parseFloat(ua.slice(ua.indexOf("Android")+8));
	if (androidversion < 4.4){
	$("<link>")
    .attr({ rel: "stylesheet",
        type: "text/css",
        href: "styles/android_hack.css"
    })
    .appendTo("head");
	//$.getScript("scripts/index_android.js");
