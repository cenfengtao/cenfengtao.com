        ...
        success:function(data){
          ...
          var listLength=list.length;
              ...
              $(".chartList").append(
                '<li onclick="details('+list[i].id+')">'+
                   ...
                   '<div class="order" id="'+i+'">'+
                       '<img src="" alt="" style="width:2.94rem;height:2.41rem;">'+
                       '<span class="num">'+list[i].ranking+'</span>'+
                   '</div>'+
               '</li>'
              )
            if(data.data.prize.length!=0){
              if(data.data.prize.length>i){
               // $(".chart ul li:gt(2) .hat").hide();
                var num=document.getElementsByClassName("num")[i].innerHTML;
                if(num=="1"){
                   $(".order").eq(i).find("img").attr("src","../../../../Public/images/prize1.png")
                    $(".hat").eq(i).show();
                    $(".img").eq(i).css({"float":"left","margin-left":"0.4rem","margin-top":"0.77rem"})
                    $(".hat").eq(i).show();
                    $(".hat").eq(i).css({"position":"absolute","top":"-0.7rem","left":"0.15rem"})
                }
                if(num=="2"){
                  $(".order").eq(i).find("img").attr("src","../../../../Public/images/silver1.png")
                  $(".hat").eq(i).show();
                  $(".img").eq(i).css({"float":"left","margin-left":"0.4rem","margin-top":"0.77rem"})
                  $(".hat").eq(i).show();
                  $(".hat").eq(i).css({"position":"absolute","top":"-0.7rem","left":"0.15rem"})
                ...
                if(num=="3"){
                  $(".order").eq(i).find("img").attr("src","../../../../Public/images/bronze1.png")
                  $(".img").eq(i).css({"float":"left","margin-left":"0.4rem","margin-top":"0.77rem"})
                  $(".hat").eq(i).show();
                  $(".hat").eq(i).css({"position":"absolute","top":"-0.7rem","left":"0.15rem"})
                }
                if(num!=1||num!=2||num!=3){
                    $(".orders").eq(i).find("img").attr("src","../../../../Public/images/redMedal.png")
                  }
              }else{
               // $(".chart ul li:gt(2) .hat").hide();
                  $("#"+i).attr("class","orders").css("margin-right","0.95rem")
                  $(".orders").find("img").css({"height":"2.28rem","width":"1.8rem"})
                  var num=document.getElementsByClassName("num")[i].innerHTML;
                  if(num=="1"){
                      $(".orders").eq(i-data.data.prize.length).find("img").attr("src","../../../../Public/images/prize.png")
                      $(".hat").eq(i).show();
                  ...
                  if(num=="2"){
                    $(".orders").eq(i-data.data.prize.length).find("img").attr("src","../../../../Public/images/silver.png")
                    $(".hat").eq(i).show();
                    $(".img").eq(i).css({"float":"left","margin-left":"0.56rem","margin-top":"0.77rem"})
                    $(".hat").eq(i).show();
                    $(".hat").eq(i).css({"position":"absolute","top":"-0.7rem","left":"0.15rem"})
                  ...
                  if(num=="3"){
                    $(".orders").eq(i-data.data.prize.length).find("img").attr("src","../../../../Public/images/bronze.png")
                    $(".img").eq(i).css({"float":"left","margin-left":"0.56rem","margin-top":"0.77rem"})
                    $(".hat").eq(i).show();
                    $(".hat").eq(i).css({"position":"absolute","top":"-0.7rem","left":"0.15rem"})
                  }
                  if(num>3){
                    $(".orders").eq(i-data.data.prize.length).find("img").attr("src","../../../../Public/images/blue.png")
                  }
                }
              }
            }
            ...
            $(".order").click(function(e){
                ...
                if(data.data.prize.length!=0){
                  $(".orderText").text(data.data.prize[index].title)
                  $(".prizeDesc").text(data.data.prize[index].desc)
                  $(".prizeImg").attr("src",data.data.prize[index].image)
                  setTimeout(function(){
                    $(".tellBox").show()
                     var contentHeight=$(".tellContent").height()
                      $(".tellContent").css("height",contentHeight)
                      $(".tellContent").css("position","absolute")
                      $(".tellContent").css("top",0)
                      $(".tellContent").css("bottom",0)
                  },100)
                }else{
                  // alert("该活动已结束，欢迎您下次活动时来查看礼品哦！")
                }
