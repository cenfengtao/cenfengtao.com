...
function confirmOrder() {
    ...
    return window.location.href = "/index.php/Parenting/confirmationInfo?par_id=" + par_id + "&amount=" + amount + "&name=" + name + "&mobile=" + mobile + "&message=" + remark + "&address=" + address_detail;
