...
function confirmOrder() {
    ...
    return window.location.href = "/index.php/Organization/confirmationInfo?id=" + id + "&amount=" + amount + "&name=" + name + "&mobile=" + mobile + "&message=" + remark + "&address=" + address_detail;
    ...
    var url = "/index.php/Orders/addActivityOrder";
    var data = {
        id: id,
        amount: amount,
        name: name,
    ...
    $.post(url, data, function (result) {
        if (result.status == 0) {
            ...
            window.location.href = "/index.php/WxPay/jsapiByActivity?orderId=" + result.orderId;
        }
    }, 'json');
}
...
function getClassTable() {
    var id = getQueryString('id');
    window.location.href = "/index.php/Organization/getClassTable?id=" + id;
}
