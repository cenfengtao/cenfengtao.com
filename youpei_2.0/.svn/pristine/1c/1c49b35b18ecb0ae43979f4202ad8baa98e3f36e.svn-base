...
function confirmOrder() {
    ...
    return window.location.href = "/index.php/Groups/confirmationInfo?groupId=" + groupId + "&amount=" + amount + "&name=" + name + "&mobile=" + mobile + "&message=" + remark + "&address=" + address_detail + "&shareUserId=" + shareUserId;
