...
function confirmOrder() {
    ...
    var key = $('.class-normal-on').attr('attr_key');
    ...
    return window.location.href = "/index.php/Product/confirmationInfo?pro_id=" + pro_id + "&amount=" + amount + "&name=" + name + "&mobile=" + mobile + "&message=" + remark + "&address=" + address_detail + "&key=" + key;
