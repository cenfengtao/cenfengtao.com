...
<div class="order-content">
    <ul>
        ...
        <li>积分兑换：&nbsp;<span>￥<?php echo $order['integral']; ?></span><span> 积分</span></li>
        <li>支付总额：&nbsp;￥<span id="need_pay"><?php echo $order['integral']; ?></span><span> 积分</span></li>
    </ul>
</div>
...
<script type="text/javascript">
    ...
    function callpay() {
        ...
        $.post("http://" + window.location.host + "/index.php/WxPay/finishByIntegral",
            {orderId: orderId}, function (result) {
            if (result.status == 1) {
                alert(result.msg);
