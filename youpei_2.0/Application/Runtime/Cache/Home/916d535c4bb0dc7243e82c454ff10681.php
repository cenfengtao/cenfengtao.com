...
<script>
    $(function () {
        ...
        var groupRecordId = getQueryString("groupRecordId");
        var amount = getQueryString("amount");
        $.get(ajaxUrl, {groupRecordId: groupRecordId, amount: amount}, function (result) {
            if (result.status == 0) {
    ...
    function addOrder() {
        ...
        var data = {
            ...
            groupRecordId : getQueryString('groupRecordId'),
