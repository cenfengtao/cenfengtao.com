...
<body class="kap-loading ty-view-all">
	...
	<div class="form">
		<form action="">
			<div class="head">
				<img src="../../../../Public/images/apoint.png" alt="" class="apoint">
				<span>预约听课时间</span>
				<img src="../../../../Public/images/close.png" alt="" class="close">
			</div>
			<div class="apointment">
				<span class="apointTime">预约时间 : </span>
				<div class="longTime">	
				</div>
			</div>
			<div class="light1">
				<label for="name" class="name">预约人姓名：</label>
	...
	<script type="text/javascript">
	 ...
	 //        return Math.ceil((d + 6 - w) / 7);
		...
		$(function(){
			...
			$.ajax({
				type:"post",
			    url:"<?php echo U('Product/getClassTableAjax');?>",
			    aysnc:true,
			    data:{
			    	pro_id:pro_id
			    },
			...
			$("tr td").click(function(){
				...
				$.ajax({
					type:"post",
				    url:"<?php echo U('Product/getBookTimeByDay');?>",
				    aysnc:true,
				    data:{
				    	pro_id:pro_id,
				    	time:time
			...
			$(".submit").click(function(){
	    		...
	    		$.ajax({
	    			type:"post",
				    url:"<?php echo U('Product/getBookReadRecord');?>",
				    aysnc:true,
				    data:{
				    	pro_id:pro_id,
				    	year:year,
