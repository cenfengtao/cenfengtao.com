...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/css/home/userVote.css"/>
   ...
   <section class="worksList">
    ...
    <section class="tellBox">
        <div class="tellContent">
            ...
            <h3>温馨提示</h3>
            <div>每天登录平台可获得2张免费票，在平台购物可获得大量票数哦!(2元=1票)</div>
...
<script src="/Public/js/home/userVote.js" type="text/javascript" charset="utf-8"></script>
...
<script>
    $.ajax({
        ...
        success:function(data){
            var title='【优培·投票】 我的投票';
            var f_title='快来查看自己投票的情况吧！';
