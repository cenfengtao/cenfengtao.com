...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/css/home/association.css"/>
    ...
    <div class="bonfire-pageloader-icon">
       <svg class="kap-loading-icon" xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px"  enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        <article class="middle">
            ...
            <div class="content">
                <div class="expert">
                    <ul>
                        <li>
                        <!-- ../../../../Application/Home/View/Association/expertDetails.html -->
                            <a href="###"><img src="/Public/image/expert1.jpg"/></a>
                            <a class="text" href="###">
                                <h4>如何通过玩积木提高孩子的动手能力</h4>
                                <span>499人次学习</span>
                                <span>专家：优小培</span>
                                <span>免费</span>
                            </a>
                        ...
                        <li>
                            <a href="###"><img src="/Public/image/expert2.jpg"/></a>
                            <a class="text" href="###">
                                <h4>网络成瘾，家长如何正确看待与引导</h4>
                                <span>523人次学习</span>
                                <span>专家：优小培</span>
                                <span><b>￥</b>9.9</span>
                            </a>
                        ...
                        <li>
                            <a href="###"><img src="/Public/image/expert3.jpg"/></a>
                            <a class="text" href="###">
                                <h4>哄宝宝睡觉的技巧</h4>
                                <span>1323人次学习</span>
                                <span>专家：优小培</span>
                ...
                <div class="communicate">
                    <div class="type">
                        <div class="left">《</div>
                        <ul class="smallNav">
                            <li class="on first" id="0"><a href="###">推荐</a></li>
                        </ul>
                        <div class="right">》</div>
                    </div>
                    <ul class="con">
                ...
                <div class="mine">
                    <ul>
                        <li>
                            <a href="###">
                                <img src="/Public/image/mine1.jpg"/>
                            </a>
                            <div class="join">
                                <span>89人进群</span>
                                <a href="###">进入</a>
                        ...
                        <li>
                            <a href="###">
                                <img src="/Public/image/mine2.jpg"/>
                            </a>
                            <div class="join">
                                <span>101人进群</span>
                                <a href="###">进入</a>
                    ...
                    <div class="more">
                        ...
                        <ul>
                            <li>
                                <a href="###">
                                    <img src="/Public/image/mine3.jpg"/>
                                </a>
                                <div class="join">
                                    <span>234人进群</span>
                                    <a href="###">进入</a>
                            ...
                            <li>
                                <a href="###">
                                    <img src="/Public/image/mine4.jpg"/>
                                </a>
                                <div class="join">
                                    <span>234人进群</span>
                                    <a href="###">进入</a>
        ...
        <footer class="footer">
            ...
            <ul class="icon">
                <li>
                    ...
                    <a href="<?php echo U('Index/index',array('current'=>'1'));?>">
        ...
        <script src="/Public/js/home/association.js" type="text/javascript" charset="utf-8"></script>
    </body>
</html>
