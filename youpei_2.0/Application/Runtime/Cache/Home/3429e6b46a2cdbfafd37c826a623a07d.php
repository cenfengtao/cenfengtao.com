...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/css/home/pageloadered.css"/>
        <link rel="stylesheet" type="text/css" href="/Public/css/home/swiper.min.css"/>
        <link rel="stylesheet" type="text/css" href="/Public/css/home/discoveryDemo.css"/>
        <!-- 判断是IE时执行 -->
    ...
    <div class="bonfire-pageloader-icon">
       <svg class="kap-loading-icon" xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px"  enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        <header class="header">
            ...
            <h3>发现</h3>
            <a href="/index.php/Map/index.html" style="position: absolute;right: 2rem; top: 0.3rem;" >
        ...
        <article class="middle">
            ...
            <section class="search">
                <div class="area">
                    <select name="searchType" id="" class="searchType">
                        <!-- type 1:文章 2:课程 3:商品 4:机构-->
                        <option value="1" selected>文章</option>
                        <option value="2">课程</option>
                        <option value="3">商品</option>
                        <option value="4">机构</option>
                    </select>
                    <img src="../../../../Public/images/searchDown.png" alt="">
                </div>
                <div class="searchWant">
                    <!--<input type="text" placeholder="搜索您想要的......" onfocus="this.blur()">-->
                    <input type="text" placeholder="搜索您想要的......" id="searchWord">
                    <img src="../../../../Public/images/indexSearch.png" onclick="searchWord();">
                </div>
            </section>
            ...
            <section class="mapContent">
                <h3>——/ <strong>机</strong> / <strong>构</strong> / <strong>找</strong> / <strong>找</strong> / <strong>看</strong> /——</h3>
                <div style="position: relative;">
                    <a href="/index.php/Map/index.html" class="map" style="z-index: 100">
                    </a>
                    <iframe src="<?php echo U('Map/discoverIndex');?>" style="width:95%; height:6.3rem;z-index: 10;margin-left: 2%; border-radius: 5px;overflow: hidden;border: 0.05rem solid #b8b1b0;position: relative; box-sizing:border-box;" frameborder="1" onload="hideHead(this)">
                    </iframe>
                    <!--<img src="../../../../Public/images/searchOrg.png" alt="" class="searchOrg">-->
                    <!--<img src="../../../../Public/images/report.png" alt="" class="report">-->
                </div>
            </section>
            <section class="activity">
                <h3>——/ <strong>活</strong> / <strong>动</strong> / <strong>专</strong> / <strong>区</strong> /——</h3>
                <ul>
                    <li>
                        <a href="http://www.youpei-exc.com/index.php/Vote/voteList.html?vote_id=11"><img src="../../../../Public/images/vote3.jpg" alt=""></a>
                    </li>
                    <li>
                        <a href="/index.php/Lottery/index?token=g232238gc959"><img src="../../../../Public/images/1495531071.png" alt=""></a>
                    </li>
                </ul>
            </section>
            <section class="groups">
                <h3>——/ <strong>最</strong> / <strong>新</strong> / <strong>内</strong> / <strong>容</strong> /——</h3>
                <div id="newest"></div>
            </section>
            <!--<section class="loadMore">
                <div>下拉加载更多<img src="../../../../Public/images/loadMore.png" alt=""></div>
            </section>-->
            <section class="alert" style="display: none;">
                <p style="background: white; font-size: 0.5rem; text-align: center; margin-bottom: 0.2rem;">亲，暂时没有内容了哦，更多精彩内容在发现页。</p>
            </section>
        </article>
        ...
        <script src="/Public/js/home/discoveryIndex.js" type="text/javascript" charset="utf-8"></script>
        <script type="text/javascript">
            // 微信端分享
            wx.config({
