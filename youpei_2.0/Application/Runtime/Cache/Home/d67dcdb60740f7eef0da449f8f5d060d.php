...
<link href="/Public/Home/css/buy.css" rel="stylesheet" type="text/css">
...
<div id="detail_activity" class="kap-page kap-page-current">
    <div class="kap-top ty-menu-top">
        <div id="tools_msg" class="ty-tools ty-tools-inner ty-tools-current">
            <span class="title"><?php echo ($group['title']); ?><span class="num"></span></span>
    ...
    <div class="ty-page">
        <div class="ty-detail-cover">
            <span class="thumb"
                  style="background-image:url(<?php echo ($group['image']); ?>); background-size:100% 8.5rem; height: 8.5rem;padding-bottom: 0" ></span>
                <span class="desc-top">
                    <span data-icon="Ć" class="loc"></span>
                </span>
            <div class="desc row">
                <span class="status">组团价: <?php echo ($group['price']); ?>元</span>
                <div class="tags">
                    <?php if(!empty($group['tagA'])): ?><span class="tag purple"><?php echo ($group['tagA']); ?></span><?php endif; ?>
                    <?php if(!empty($group['tagB'])): ?><span class="tag orange"><?php echo ($group['tagB']); ?></span><?php endif; ?>
                    <?php if(!empty($group['tagC'])): ?><span class="tag yellow"><?php echo ($group['tagC']); ?></span><?php endif; ?>
                    <label class="size red">原价：<?php echo ($group['original_price']); ?>元</label>
                </div>
            </div>
            <!--<div class="introduce">-->
            ...
            <div class="border item curriculum" style="display: none;">
                <i class="icon1"></i>
                <label>预约试听课</label>
                <span class="tip" data-icon-after="Ĩ"></span>
            </div>
            <div class="border item peo">
                <b>已有<?php echo ($userCount); ?>人报名</b>
                <span class="pro"><a href="/index.php/Groups/checkOrderInformation?groupRecordId=<?php echo ($groupRecordId); ?>" style="color:#fff;">立即加入</a></span>
            </div>
            <div class="clear"></div>
            <div class="border item company" onclick="organ(<?php echo ($organization['id']); ?>)">
                <i class="icon2"></i>
                <label>教学单位</label>
                <span class="tip" data-icon-after="Ĩ"></span>
            ...
            <div class="mechanism">
                ...
                <div class="score" id="descs" style="line-height: 1.3rem;">
                 ...
                 <span class="star" data-ty-talent-star="5">
                     <?php $__FOR_START_19557__=0;$__FOR_END_19557__=$organization['org_star'];for($$organization['org_star']=$__FOR_START_19557__;$$organization['org_star'] < $__FOR_END_19557__;$$organization['org_star']+=1){ ?><i class="on iconfont">Ŧ</i><?php } ?>
                    </span>
                    <span>环境评级</span>
                 <span class="star" data-ty-talent-star="5">
                    <?php $__FOR_START_5552__=0;$__FOR_END_5552__=$organization['env_star'];for($$organization['env_star']=$__FOR_START_5552__;$$organization['env_star'] < $__FOR_END_5552__;$$organization['env_star']+=1){ ?><i class="on iconfont">Ŧ</i><?php } ?>
                    </span>
                    <span>教学质量</span>
                 <span class="star" data-ty-talent-star="5">
                     <?php $__FOR_START_27196__=0;$__FOR_END_27196__=$organization['quality_star'];for($$organization['quality_star']=$__FOR_START_27196__;$$organization['quality_star'] < $__FOR_END_27196__;$$organization['quality_star']+=1){ ?><i class="on iconfont">Ŧ</i><?php } ?>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="ty-detail-content">
            <div class="article-title" id="kcxq">
                <span class="title">课程详情</span><img src="/Public/images/xianqin.png" height="72" class="kcxq">
            </div>
            <div class="article top">
                <div class="text"><?php echo ($group['description']); ?>
            ...
            <div class="article">
                <div class="text"><?php echo ($group['cost']); ?></div>
            </div>
            ...
            <a data-icon="Ė" class="btn-continue" id="comments"
               href="/index.php/Groups/checkOrderInformation?groupRecordId=<?php echo ($groupRecordId); ?>">赶紧下单</a>
            ...
            <div class="article">
                ...
                <ul class="list-comment">
                    <?php if(is_array($commentList)): $k = 0; $__LIST__ = array_slice($commentList,0,15,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><li class="item">
                            ...
                            <div class="replys">
                                <?php if(is_array($val['child'])): $i = 0; $__LIST__ = $val['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><div class="reply" onclick='getFatherId("<?php echo ($va['id']); ?>","<?php echo ($val['id']); ?>")'>
                                    ...
                                    <div class="image"><img src="<?php echo ($va['headImg']); ?>" alt="">回复：<img src="<?php echo ($va['headImgs']); ?>" alt=""></div>
    ...
    <div id="tools_detail_activity" class="ty-tools ty-tools-order ty-tools-current">
        <div class="ty-tools-detail-btns">
            ...
            <a href="javascript:void(0);" data-ty-target="#page_talent" data-ty-talentid=""
               class="btn-detail shop more">
                <i class="icon5"></i><br>
                推荐</a>
            <a href="/index.php/Groups/checkOrderInformation?groupRecordId=<?php echo ($groupRecordId); ?>" class="btn-order">我要报名</a>
        </div>
    </div>
</div>
...
<script src="/Public/js/home/getGroup.js" type="text/javascript" charset="utf-8"></script>
