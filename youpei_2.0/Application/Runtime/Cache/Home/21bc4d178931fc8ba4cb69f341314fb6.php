...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/css/home/groupsDemo.css"/>
        <!-- 判断是IE时执行 -->
    ...
    <div class="bonfire-pageloader-icon">
       <svg class="kap-loading-icon" xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px"  enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        <article class="middle">
            <section class="advert" style="display: none;">
                <a href="javascript:void(0);"><img src="../../../../Public/images/groupsAdvert.jpg" alt=""></a>
            </section>
            <section class="classify">
                <div class="groupsType">
                    <ul>
                        <li class="on" id="1">课程团购</li>
                        <li id="2">商品团购</li>
                    </ul>
                </div>
                <div class="nav">
                    <div class="classifyNav courseNav">
                        <ul>
                            <li class="on" attr_id="type"><a href="javascript:void(0);" attr_id="0">全部</a></li>
                        </ul>
                    </div>
                    <div class="classifyNav shopNav" style="display: none;">
                        <ul>
                            <li class="on" attr_id="type"><a href="javascript:void(0);" attr_id="0">全部</a></li>
                        </ul>
                    </div>
                ...
                <div class="filter" style="display: none;">
                    ...
                    <span class="price">价格<img src="../../../../Public/images/priceIcon.png" alt=""></span>
                    <span class="hr">|</span>
                ...
                <div class="content">
                    ...
                    <div class="shopGroups" style="display: none;">
                        <ul>
                        </ul>    
                    </div>
                </div>
        ...
        <footer class="footer">
            ...
            <ul class="icon">
                <li>
                    ...
                    <a href="/index.php/Groups/index.html">
                        <img src="/Public/images/groupsIcon3.png"/>
                        <span>参团</span>
                    </a>
                </li>
                <li>
                    <img src="/Public/image/circle.png" alt="">
                    <a href="/index.php/Groups/addGroup.html">
                        <img src="/Public/images/groupsIcon2.png"/>
                        <span>愿望单</span>
                    </a>
                </li>
                <li>
                    <img src="/Public/image/circle.png" alt="">
                    <a href="/index.php/Groups/myGroups.html">
                        <img src="/Public/images/groupsIcon1.png"/>
                        <span>我的团</span>
                    </a>
                </li>
            </ul>
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if(data.status==1){
                                        ...
                                        if(data.groupProduct.length==0){
                                            $(".courseList ul").append(
                                                    '<li style="text-align:center; font-size:0.5rem;">亲，暂时没有此类团购商品哦！</li>'
                                                )
                                        }
                                    }
                             ...
                             $.ajax({
                                ...
                                success: function (data) {
                                    if(data.status==1){
                                        ...
                                        if(data.groupProduct.length==0){
                                            $(".shopGroups ul").append(
                                                    '<li style="text-align:center; font-size:0.5rem;width:100%;height:1rem;">亲，暂时没有团购商品哦！</li>'
                                                )
                                        }
                                ...
                                success: function (data) {
                                    if(data.status==1){
                                        ...
                                        for(var i=0; i<groupProductLength; i++){
                                         ...
                                         if(data.groupProduct.length==0){
                                            $(".shopGroups ul").append(
                                                    '<li style="text-align:center; font-size:0.5rem;width:100%;height:1rem;">亲，暂时没有此类团购商品哦！</li>'
                                                )
                                        }
                                    }
...
$(function () {
    ...
    setInterval(function () {
        ...
        //                 '<a href="">去拼团</a>'+
        //                 '<div class="groupNum">'+
        //                     '<span class="finished">已拼团人数 : (<span class="nowPeople">6</span>/<span class="allPeople">10</span>)</span>'+
        //                     '<div class="bar"><span></span></div>'+
        //                 '</div>'+
        //             '</div>'+
        //         '</li>'
