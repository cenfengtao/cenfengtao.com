...
<link rel="stylesheet" href="/Public/css/home/addGroup.css">
<div id="page_user" title="<?php echo ($title); ?>" class="kap-page kap-page-current">
    ...
    <div class="user-area">
                ...
                <li>
                    ...
                    <div class="group-right">
                        <select name="org_token" onchange="chooseOrg()">
                            ...
                            <?php if(is_array($orgList)): foreach($orgList as $key=>$val): ?><option value="<?php echo ($val['token']); ?>" style="font-size:0.5rem;"><?php echo ($val['org_name']); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    <hr>
                </li>
        ...
        <div class="hope-order">
            ...
            <img src="../../../../Public/images/want.jpg" class="want"/>
        </div>
    </div>
    <!-- 底部菜单 -->
    <div class="kap-bottom ty-menu-bottom">
        <div id="tools_idx" class="ty-tools ty-tools-idx ty-tools-current">
            <a href="<?php echo U('Index/index',array('current'=>'1'));?>" data-ty-target="#page_hot" data-icon=""><i
                    style="background: url('/Public/images/1497609486.png') center center/70% 70% no-repeat; display:block;"
                    class="on"> </i>首页</a>
            <i class="border"></i>
            <a href="<?php echo U('Groups/index',array('current'=>'2'));?>"
            <?php if($current == 2): ?>class="current"<?php endif; ?>
            data-ty-target="#page_discover" data-icon="" onclick="_hmt.push(['_trackEvent', 'footbar', 'click', '发现'])"><i
                style="background: url('/Public/images/1497609958.png')center center/70% 70% no-repeat; display:block;"
                class="on"> </i>入团</a>
            <i class="border"></i>
            <a href="<?php echo U('Groups/addGroup',array('current'=>'3'));?>" class="current"
            data-ty-target="#detail_msg" data-icon="" onclick="_hmt.push(['_trackEvent', 'footbar', 'click', '消息'])"><i
                style="background: url('/Public/images/1497609579.png')center center/70% 70% no-repeat; display:block;"
                class="on"> </i>组团<i id="new_msg_alert"></i></a>
            <i class="border"></i>
            <a href="<?php echo U('Groups/myGroups',array('current'=>'4'));?>"
            <?php if($current == 4): ?>class="current"<?php endif; ?>
            data-ty-target="#page_user" data-icon="" onclick="_hmt.push(['_trackEvent', 'footbar', 'click', '我的'])"><i
                style="background: url('/Public/images/1497609711.png')center center/70% 70% no-repeat; display:block;"
                class="on"></i>我的团</a>
        </div>
    </div>
</div>
...
<script src="/Public/js/home/addGroup.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>