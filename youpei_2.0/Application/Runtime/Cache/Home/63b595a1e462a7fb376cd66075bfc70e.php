    ...
    <div class="bonfire-pageloader-icon">
       <svg class="kap-loading-icon" xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px"  enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        <article class="middle">
            <section class="advert" style="height: 3.75rem;">
                <img src="../../../../Public/images/group1.jpg" alt="" style="height: 3.75rem;">
            </section>
            <section class="date">
				...
				<div class="arrange">
                    ...
                    <div class="uploadInfo" style="display: none;">
                        ...
                        <span class="uploadClass" attr-year="" attr-month="" attr-day="">添加课程</span>
                    </div>
                    <div class="uploadContent" style="display: none;">
                        <form>
                            ...
                            <label class="classTimes">
                                ...
                                <input type="text" id="test1" style="width: 2.2rem;"  name="start_hour_time" readonly="readonly">
                                </select>
                                <span class="contain">一</span>
                                <!--<input type="time" id="test2" style="width: 2.2rem;" value="00:00" name="end_hour_time">-->
                                <input type="text" id="test2" style="width: 2.2rem;" name="end_hour_time">
                            </label>
                            <hr>
                            ...
                            <!-- <label class="userTel">
                                <span>手机号码：</span>
                                <input type="number" placeholder="请输入......(必填)" name="mobile" maxlength="11">
                            </label>
                            <hr> -->
            ...
            <section class="tellBox">
                <div class="tellContent form-message">
                    <img src="../../../../Public/images/close.png" alt="" class="closeBtn">
                    <h3>温馨提示</h3>
                    <div>您还没有在该平台绑定手机号码哦，请您填写下面信息进行提交信息绑定，才能获取您即将要上课的信息哦。</div>
                    <p>手 &ensp; 机：<input type="tel" name="mobiles" maxlength="11" placeholder="请输入手机号码"></p>
                    <p>验证码：<input type="number" max="4" name="code" style="width: 2.1rem;"  placeholder="请输入验证码">
                        <button id="code" onclick="getCode()">接收验证码</button>
                    </p>
                    <button onclick="submitInfo()" class="submit">提交信息</button>
                </div>
            </section> 
            <section class="tellBoxs"></section>
        </article>
        ...
        <script src="/Public/js/home/city.js" type="text/javascript" charset="utf-8"></script>
        ...
        <script src="/Public/js/home/font.js" type="text/javascript" charset="utf-8"></script>
         <script src="/Public/js/laydate/laydate.js" type="text/javascript" charset="utf-8"></script> 
        <script src="/Public/js/home/schedule.js" type="text/javascript" charset="utf-8"></script>
        <script type="text/javascript">
        	$(function(){
