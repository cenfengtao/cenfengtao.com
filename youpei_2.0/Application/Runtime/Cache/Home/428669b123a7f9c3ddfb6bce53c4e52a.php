                                ...
                                success: function (data) {
                                    if(data.status==1){
                                        ...
                                        for(var i=0; i<groupProductLength; i++){
                                         ...
                                         if(data.groupProduct.length==0){
                                            $(".shopGroups ul").append(
                                                    '<li style="text-align:center; font-size:0.5rem;width:100%;height:1rem; clear:both;">亲，暂时没有此类团购商品哦！</li>'
                                                )
                                        }
                                    }
	                            ...
	                            success: function (data) {
	                                if(data.status==1){
	                                    ...
	                                    var groupProductLength=data.groupProduct.length;
	                                        ...
	                                        if(data.groupProduct.length==0){
	                                            $(".shopGroups >div").html(
	                                                    '<p style="text-align:center; font-size:0.5rem;width:100%;height:1rem;clear:both;">亲，暂时没有更多团购商品了！</p>'
	                                                )
	                                        }
	                                    }
	                            }
