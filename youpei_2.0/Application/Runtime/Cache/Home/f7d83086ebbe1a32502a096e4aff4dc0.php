...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/css/home/userContribution.css"/>
...
<article class="middle" style="position: relative;"> 
     <form  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left form-youpei">
        <section class="works">
         ...
         <section class="works">
            <span style="margin-left: 1.29rem;">*作者：</span>
         ...
         <section class="works" style="display: none;">
             <span style="margin-left: 0.8rem;">*年龄段：</span>
        ...
        <section class="img" id="img1">
         ...
         <section class="upload">
          <a href="#img" onclick="firstFile(0)">点击上传/修改第一幅图（封面图）</a>
        </section>
         <section class="upload">
             <a href="#img1" onclick="firstFile(1)" style="display: none;" class="oneUpload" id="oneUpload">点击继续上传/修改第二幅图</a>
         </section>
         <section class="upload">
             <a href="#img2" onclick="firstFile(2)" style="display: none;" class="twoUpload" id="twoUpload">点击继续上传/修改第三幅图</a>
         </section>
    ...
    <section class="tellBox" style="display: none;">
        <div class="tellContent">
            ...
            <h3>温馨提示</h3>
            <div>1.投稿成功，请长按下面二维码关注优培圈及时获取最新投票进展信息。</br>2.投稿成功后需活动方审核通过后才能在相关页面显示，可在“我的作品”页查看审核状态。</div>
    ...
    <section class="tellBoxs" style="display: none;">
        <div class="tellContents">
            <img src="../../../../Public/images/close.png" alt="" class="closeBtn">
            <h3>温馨提示</h3>
            <div>1.重新投稿成功，请长按下面二维码关注优培圈及时获取最新投票进展信息。</br>2.投稿成功后需活动方审核通过后才能在相关页面显示，可在“我的作品”页查看审核状态。</div>
            <img src="../../../../Public/images/ypq_qrcode.jpg" alt="" class="code">
        </div>
    </section>
</article>
...
<!-- <script src="/Public/js/webuploader/batchupload.js"></script> -->
<script src="/Public/js/webuploader/webuploader.custom.js"></script>
...
$(function(){
            ...
            if(data.status==1){
              ...
              window.sessionStorage.setItem("upload_type",data.data.type)
                if(data.data.type==1){
                  ...
                  $(".explain").append(
                      '<h3>投稿说明：</h3>'+
                     ' <p>1.每个按钮可上传1幅图片，最多可上传3幅图片,由上到下顺序上传。</p>'+
                      '<p>2.投稿成功后需活动方审核通过后才能在相关页面显示，可在“我的作品”页查看审核状态。。</p>'
                    )
                  if(data.data.userUpload.upload_status==2){
                      ...
                      var imgSrc=$("#img img").attr("src")
                       if(imgSrc!=""){
                        $(".oneUpload").show()
                        $("#img").append('<p>第一幅图片</p>')
                        $("#img img").css("paddingTop","1rem")
                      }else{
                        $("#img img").remove()
                      }
                      ...
                      if(imgSrc1!=""){
                        $(".twoUpload").show()
                        $("#img1").append('<p>第二幅图片</p>')
                        $("#img1 img").css("paddingTop","1rem")
                      }else{
                        $("#img1 img").remove()
                      }
                      ...
                      if(imgSrc2!=""){
                        $("#img2").append('<p>第三幅图片</p>')
                        $("#img2 img").css("paddingTop","1rem")
                      }else{
                        $("#img2 img").remove()
                      }
                      $(".alert").hide()
 ...
 //      data:{},
 //      success:function(data){
 //        attentions=data.data.userStatus;
 //        window.sessionStorage.setItem("attentions",attentions)
 //      }
