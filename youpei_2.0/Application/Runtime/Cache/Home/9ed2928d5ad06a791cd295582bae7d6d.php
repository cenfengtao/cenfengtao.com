...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/css/home/checkOrderInformation.css"/>
    ...
    <div class="bonfire-pageloader-icon">
       <svg class="kap-loading-icon" xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px"  enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        <article class="middle">
            <section class="img">
                <img src="<?php echo ($product['pic_url']); ?>" alt="">
                <div class="text"><?php echo ($product['title']); ?> <?php echo ($product['price']['class_normal']); ?></div>
            </section>
            <!--<section class="schedule" onclick="getClassTable(<?php echo ($product['id']); ?>)">
                <img src="/Public/images/schedule.png" alt="">
                <span>预约试听课</span>
                <img src="/Public/images/next.png" alt="">
            </section>-->
            <section class="schedule">
                <img src="/Public/images/chose.png" alt="">
                <span>选择规格</span>
            </section>
            <section>
                <div>
                    <?php if(is_array($product["price"])): foreach($product["price"] as $k=>$val): ?><a href="javascript:changeNormal(<?php echo ($k); ?>);" class="class-normal-child" id="normal-<?php echo ($k); ?>"><?php echo ($val['class_normal']); ?></a><?php endforeach; endif; ?>
                </div>
            </section>
            ...
            <section class="course">
                <div class="num">
                    <div>
                        <a href="###" class="reduce" onclick="reduceProductN(<?php echo ($product['price']['now_price']); ?>);">-</a>
                        <input type="number" value="1" min="1" max="100" id="amount" class="number" readonly="readonly">
                        <a href="###" class="add" onclick="addProductN(<?php echo ($product['price']['now_price']); ?>);">+</a>
                    </div>
                </div>
            </section>
            <section class="pay">
                <p class="all">合计：<span class="price-off">￥<?php echo ($product['price'][$firstKey]['now_price']); ?></span></p>
                <p class="really">实付：<strong class="price-full">￥<?php echo ($product['price'][$firstKey]['now_price']); ?></strong></p>
            ...
            <section class="nextStep">
                <a href="javascript:confirmOrder()">提交订单</a>
            </section>
        </article>
        <footer class="footer">
        ...
        <script src="/Public/js/home/checkOrderInformation.js" type="text/javascript" charset="utf-8"></script>
            ...
            function changeNormal(key) {
                ...
                $.get(url, {pro_id: pro_id, key: key}, function (result) {
                    if(result.status == 0){
                        ...
                        var totalPrice = result.data.normal.now_price * amount;
                        $('input[name="class-now-price"]').val(result.data.normal.now_price);
                        $('.price-off').text(totalPrice);
                        $('.price-full').text(totalPrice);
                    }
                }, 'json')
            }
