...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/css/home/voteList.css"/>
    <style>
       /* .search{
            background: white;
            margin: 0.2rem 0;
                        ...
                        for(var i=0;i<joinUserLength; i++){
                             $("#content").append(
                                '<li onclick="toVote('+joinUser[i].id+')" id="'+joinUser[i].id+'" class="box">'+
                                    '<div class="img">'+
                                         '<img class="lazy" alt="" data-original="'+joinUser[i].path+'" alt="" onload="water()">'+
                                         // '<span>'+joinUser[i].id+'</span>'+
                                    '</div>'+
                                    '<p class="name">名称：<span>'+joinUser[i].title+'</span></p>'+
                                    '<p>作者：<span>'+joinUser[i].username+'</span></p>'+
                                    '<div class="text">'+
                                        '<span class="getNum">共获<strong>'+joinUser[i].vote_count+'</strong>票</span>'+
                        ...
                        for(var j=0;j<joinUserLength; j++){
                             $("#content").append(
                                '<li onclick="toVote('+joinUser[j].id+')" id="'+joinUser[j].id+'" class="box">'+
                                    '<div class="img">'+
                                         '<video src="'+joinUser[j].path+'" autoplay></video>'+
                                         // '<span>'+joinUser[i].id+'</span>'+
                                    '</div>'+
                                    '<p class="name">名称：<span>'+joinUser[j].title+'</span></p>'+
                                    '<p>作者：<span>'+joinUser[j].username+'</span></p>'+
                                    '<div class="text">'+
                                        '<span class="getNum">共获<strong>'+joinUser[j].vote_count+'</strong>票</span>'+
                                        '<span class="vote">为TA投票</span>'+
                                    '</div>'+
                                '</li>')
                        } 
