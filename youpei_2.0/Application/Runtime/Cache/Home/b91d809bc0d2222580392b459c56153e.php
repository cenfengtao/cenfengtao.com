...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/css/home/voteDetail.css"/>
...
<article class="middle">
    ...
    <section class="join" style="display: none;">
        <a href="javascript:void(0)" onclick="" class="judge">我也要参加</a>
    </section>
    <!-- <section class="text"> -->
<!--         <p><span>· </span>活动介绍：我和家人绘画比赛，欢迎广大小画家参加。</p>
        <p><span>· </span> 活动奖品：书包、笔记本电脑、IphoneX。</p> -->
    <!-- </section> -->
    <section class="morePeople" style="display: none;">
    ...
    <section class="tellBox">
        <div class="tellContent">
            ...
            <h3>温馨提示</h3>
            <div>你的票数不足哦！每天登录平台可获得2张免费票，在平台购物可获得大量票数哦!(2元=1票)</div>
            <a href="/index.php/Boutique/index.html">点击跳转精选商品页</a>
        </div>
    </section>
    <section class="tellBoxs" style="display: none;">
        <div class="tellContents">
            <img src="../../../../Public/images/close.png" alt="" class="closeBtn">
            <h3>温馨提示</h3>
            <div>恭喜您投票成功，请长按下面二维码关注优培圈及时获取最新投票进展信息。</div>
...
<script src="/Public/js/home/voteDetail.js" type="text/javascript" charset="utf-8"></script>
