...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/css/homes/userBillboard.css"/>
...
<script src="/Public/js/homes/userBillboard.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="/Public/Home/js/jweixin-1.0.0.js"></script>
<script>
    $(function(){
        $(".closeBtn").click(function(){
            $(".tellContent").removeAttr("style")
            $(".tellBox").hide();
        })
    })
    $.ajax({
        ...
        success:function(data){
            var share_title=data.data.title;
            var title='【优培·投票】'+share_title+'排行榜';
            var f_title=share_title+'排行榜，快来查看自己有没有上榜！！';
