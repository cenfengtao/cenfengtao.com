...
<link rel="stylesheet" href="/Public/Home/css/new_menu.css">
<link rel="stylesheet" href="/Public/css/home/article.css">
<style>
    .list li{
        height: auto;
    }
...
<div id="page-user" title="<?php echo ($title); ?>" class="kap-page kap-page-current">
    <div class="kap-top ty-menu-top">
        <div id="tools-msg" class="ty-tools ty-tools-inner ty-tools-current">
            <span class="title">优培好文<span class="num"></span></span>
            ...
            <!--<a href="" class="saixuan"><img src="/Public/images/saixuan.png" alt="">筛选</a>-->
        </div>
    </div>
    <div class="kap-wrap">
        <div id="page_hot" title="热推" class="kap-page kap-page-current"
            ...
            <div class="ty-page">
                <div class="ty-cat-tags">
                    <ul class="list-rec">
                        <li class="item">
                            <div class="ty-rec-view ty-sc-h cateList">
                                <span onclick="getCateListById(0)" attr_id="0"></span>
                            </div>
                        </li>
                    </ul>
                </div>
                <input type="hidden" id="page" value="10">
                <div class="timeline-product" style="margin-top:74px;padding-top: 115px;">
                    <ul class="list-card-timeline lists list">
                    </ul>
...
<script src="/Public/js/home/article.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>