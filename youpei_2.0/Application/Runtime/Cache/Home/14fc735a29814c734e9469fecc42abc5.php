       ...
       <svg class="kap-loading-icon" xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px"  enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        <article class="middle">
            ...
            <section class="mapContent">
                <h3>——/ <strong>机</strong> / <strong>购</strong> / <strong>找</strong> / <strong>找</strong> / <strong>看</strong> /——</h3>
                <div style="position: relative;"> 
                    <a href="/index.php/Map/index.html" class="map" style="z-index: 100">
                    </a>
                    <iframe src="<?php echo U('Map/discoverIndex');?>" style="width:95%; height:6.3rem;z-index: 10;margin-left: 2%; border-radius: 10px;overflow: hidden;border: 0.01rem solid #b8b1b0;position: relative;" frameborder="0" onload="hideHead(this)">
                    </iframe> 
            ...
            <section class="activity">
                ...
                <ul>
                    <li>
                        <a href="javascript:void(0);"><img src="../../../../Public/images/1495531071.png" alt=""></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img src="../../../../Public/images/1495531071.png" alt=""></a>
                    </li>
                ...
                <section class="classify">
                    <div class="content">
                        <div class="article">
                            ...
                            <div class="right">
                                <img src="../../../../Public/images/scheduleImg.jpg" alt="">
                            </div>
                        </div>
                        <div class="courseList">
                            <ul>
                                <li>
                                    <div class="img">
                                        <img src="../../../../Public/images/scheduleImg.jpg" alt="" class="courseImg">
                                        <div class="tap">
                                            <img src="../../../../Public/images/imgTap.png" alt="" class="logoTap">
                                            <img src="../../../../Public/images/imgLogo.png" alt="" class="imgLogo">
                                        </div>
                                        <div class="type">
                                            <span>48课时</span>
                                            <span>名师</span>
                                    ...
                                    <div class="text">
                                        <div class="time">
                                            ...
                                            <span>还剩下1天 18:47:47</span>
                                        </div>
                                        <h3>优培积木3课时</h3>
                                        <span class="groupPrice">组团价：<span class="moneySign">￥</span><strong>1600</strong></span>
                                        <p class="originalPrice">原价：2288元/人</p>
                                        <a href="">立即加入</a>
                                        <div class="groupNum">
                                            <span class="finished">已拼团人数 : (<span class="nowPeople">3</span>/<span class="allPeople">10</span>)</span>
                ...
                <section class="shopBargain">
                    <ul>
                        <li>
                            ...
                            <div class="img">
                                <img src="../../../../Public/images/school_article2.jpg" alt="">
                            </div>
                            <div class="text">
                                <h3>迷宫棋</h3>
                                <p>
                                    <span>平台价：￥<strong>209</strong></span>
                                </p>
                                <div class="type">
                                    <span>动手</span>
                                    <span>益智</span>
                ...
                <section class="course">
                    <div class="courseContent">
                        <div class="swiper-container2">
                            <div class="swiper-wrapper coursesList">
                            ...
                            <div class="pagination2" style="width: 100%;text-align: center;"></div>     
                         </div>        
                    </div>
                </section>
                <section class="shopGroups">
                    <ul>
                        <li>
                            <div class="img">
                                <div class="time">
                                    <span>还剩1天 18：20：19</span>
                                </div>
                                <div class="type">
                                    <span class="originalPrice">原价:￥145</span>
                                    <span class="tab">动手</span>
                                    <span class="tab">益智</span>
                                </div>
                                <img src="../../../../Public/images/school_article2.jpg" alt="">
                            </div>
                            <div class="text">
                                <h3>迷宫棋</h3>
                                <div>
                                    <span class="groupPrice">团购价:￥<strong>36</strong></span>
