...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/css/home/personalDemo.css"/>
        <link rel="stylesheet" type="text/css" href="/Public/index/member/css/dialog.css" />
        <style>
            .dialogWindow.alert{
                width: 6rem!important;
            }
            .dialogWindow.alert div{
    ...
    <script language="javascript" type="text/javascript" src="//js.users.51.la/19366332.js"></script>
    <a href="//www.51.la/?19366332" target="_blank"><img alt="&#x6211;&#x8981;&#x5566;&#x514D;&#x8D39;&#x7EDF;&#x8BA1;" src="//img.users.51.la/19366332.asp" style="border:none;" /></a>
</div>
       ...
       <svg class="kap-loading-icon" xmlns="http://www.w3.org/2000/svg"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px"  enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        <article class="middle">
            <section class="head">
                ...
                <div class="headRight">
                    <img src="../../../../Public/images/ypq_qrcode.jpg" alt="">
                    <span>优培通行码</span>
                </div>
                <div class="ty-qrcode-area" style="display: none"><span class="qrcode"><img src="/Public/images/618348288222690487.jpg" alt="" width="200" height="200">请长按二维码关注</span></div>
            </section>
            <section class="integral">
                <div class="title">
                    <img src="../../../../Public/images/integral.png" alt="">
                    <span>我的积分</span>
                    <a href="/index.php/MemberIntegral/integrallist.html">详情 ></a>
                </div>
                ...
                <div class="integralNum">
                    <span class="getIntegral"><?php echo ((isset($totalGetIntegral) && ($totalGetIntegral !== ""))?($totalGetIntegral): 0); ?></span>
                    <span style="font-family: '宋体';margin: 0 0.5rem;">-</span>
                    <span class="useIntegral"><?php echo ((isset($totalUseIntegral) && ($totalUseIntegral !== ""))?($totalUseIntegral): 0); ?></span>
                    <span style="font-family: '宋体';margin: 0 0.5rem;">=</span>
                    <span class="leaveIntegral"><?php echo ((isset($user['integral']) && ($user['integral'] !== ""))?($user['integral']): 0); ?></span>
                </div>
                <div class="integralUse">
                    <a href="/index.php/Coupon/integralSaleArea.html">积分兑换商品！</a>
                    <a href="javascript:void(0);" class="getMore">获取更多积分？</a>
                </div>
                <a href="http://www.youpei-exc.com/index.php/Article/getArticle?art_id=245&token=g232238gc959"><img src="../../../../Public/images/say.jpg" style="width: 100%; height: auto;" alt=""></a>
            </section>
            <section class="myTasks">
                <div class="title">
                    <img src="../../../../Public/images/myTasks.png">
                    <span>我的任务</span>
                    <!-- <a href="javascript:void(0);">更多 ></a> -->
                </div>
                <div class="situation">未完成任务（<strong style="font-size: 0.4rem;"></strong>），<span>完成可领<strong style="font-size: 0.4rem;" class="getAll"></strong>积分！</span></div>
                <ul>
                    <?php if($personalData == 2): ?><li>
                            <a href="javascript:void(0);" onclick="personal()">
                                <span>完善个人资料</span>
                                <span  class="mark">40分</span>
                            </a>
                            <i class="red"></i>
                        </li><?php endif; ?>
                    <li>
                        <?php if($isTodayInvite == 1): ?><a href="javascript:void(0);" onclick="student()">
                                <span>发展学友</span>
                                <span><?php echo ((isset($taskIntegral['task_schoolmate_integral'] ) && ($taskIntegral['task_schoolmate_integral'] !== ""))?($taskIntegral['task_schoolmate_integral'] ):0); ?>分</span>
                            </a>
                            <i class="gray"></i> 
                        <?php else: ?>
                            <a href="javascript:void(0);" onclick="student()">
                                <span>发展学友</span>
                                <span class="mark"><?php echo ((isset($taskIntegral['task_schoolmate_integral'] ) && ($taskIntegral['task_schoolmate_integral'] !== ""))?($taskIntegral['task_schoolmate_integral'] ):0); ?>分</span>
                            </a>
                            <i class="red"></i><?php endif; ?>    
                    </li>
                    <li class="article">
                        <?php if($todayReadCount >= 3): ?><a href="javascript:void(0);" onclick="today_share()">
                               <span>阅读3篇未阅</br>读过的文章</span>
                                <span><?php echo ((isset($taskIntegral['task_read_integral'] ) && ($taskIntegral['task_read_integral'] !== ""))?($taskIntegral['task_read_integral'] ):0); ?>分</span>
                            </a>
                            <i class="gray"></i> 
                        <?php else: ?>
                            <a href="javascript:void(0);" onclick="today_share()">
                                 <span>阅读3篇未阅</br>读过的文章</span>
                                 <span class="mark"><?php echo ((isset($taskIntegral['task_read_integral'] ) && ($taskIntegral['task_read_integral'] !== ""))?($taskIntegral['task_read_integral'] ):0); ?>分</span>
                            </a>
                            <i class="red"></i><?php endif; ?>
                    </li>
                    <li>
                        <?php if($isShare == 1): ?><a href="javascript:void(0);">
                                 <span>转发文章</span>
                                <span><?php echo ((isset($taskIntegral['task_share_integral'] ) && ($taskIntegral['task_share_integral'] !== ""))?($taskIntegral['task_share_integral'] ):0); ?>分</span>
                            </a>
                            <i class="gray"></i> 
                        <?php else: ?>
                            <a href="javascript:void(0);" onclick="today_share()">
                                 <span>转发文章</span>
                                <span  class="mark"><?php echo ((isset($taskIntegral['task_share_integral'] ) && ($taskIntegral['task_share_integral'] !== ""))?($taskIntegral['task_share_integral'] ):0); ?>分</span>
                            </a>
                            <i class="red"></i><?php endif; ?>    
                    </li>
                    <li>
                        <?php if($isTodayComment == 1): ?><a href="javascript:void(0);">
                                <span>发表文章评论</span>
                                <span><?php echo ((isset($taskIntegral['task_comment_integral'] ) && ($taskIntegral['task_comment_integral'] !== ""))?($taskIntegral['task_comment_integral'] ):0); ?>分</span>
                            </a>
                            <i class="gray"></i> 
                        <?php else: ?>
                            <a href="javascript:void(0);" onclick="today_share()">
                                <span>发表文章评论</span>
                                <span  class="mark"><?php echo ((isset($taskIntegral['task_comment_integral'] ) && ($taskIntegral['task_comment_integral'] !== ""))?($taskIntegral['task_comment_integral'] ):0); ?>分</span>
                            </a>
                            <i class="red"></i><?php endif; ?>
                    </li> 
                    <li>
                        <?php if($isSign == 0): ?><a href="javascript:void(0);" onclick="signin()">
                                <span>签到</span>
                                <span class="mark"><?php echo ((isset($taskIntegral['task_sign_integral'] ) && ($taskIntegral['task_sign_integral'] !== ""))?($taskIntegral['task_sign_integral'] ):0); ?>分</span>
                            </a>
                            <i class="red"></i> 
                        <?php else: ?>
                            <a href="javascript:void(0);">
                                <span>签到</span>
                                <span><?php echo ((isset($taskIntegral['task_sign_integral'] ) && ($taskIntegral['task_sign_integral'] !== ""))?($taskIntegral['task_sign_integral'] ):0); ?>分</span>
                            </a>
                            <i class="gray"></i><?php endif; ?>
                    </li>  
                </ul>
            </section>
            <section class="classmates">
                <div class="title">
                    <img src="../../../../Public/images/classmates.png" alt="">
                    <span>我的学友</span>
                    <!-- <a href="javascript:void(0);">更多 ></a> -->
                </div>
                <a href="javascript:void(0);" class="getClassmates">如何获得学友？</a>
                <p>
                    <span>学友数量：<strong><?php echo ($friend_count); ?></strong>人</span>
                    <a href="/index.php/Friends/index.html">查看</a>
                </p>
            </section>
            <section class="trends">
                <div class="title">
                    <img src="../../../../Public/images/trends.png" alt="">
                    <span>我的动态</span>
                </div>
                <div class="trendsContent">
                    <ul>
                        <li><a class="" href="/index.php/personal/myMatch.html"><img src="/Public/images/myMatch.png" alt=""></a></li>
                        <li><a class="" href="/index.php/personal/myBargain.html"><img src="/Public/images/bargainIcon.png" alt=""></a></li>
                        <li><a class="" href="/index.php/Groups/myGroups.html"><img src="/Public/images/myShop.png" alt=""></a></li>
                        <li><a class="" href="/index.php/personal/appointList.html"><img src="/Public/images/appointIcon.png" alt=""></a></li>
                    </ul>
                </div>
            </section>
            <section class="coupons">
                <div class="title">
                    <img src="../../../../Public/images/coupons.png" alt="">
                    <span>我的电子券</span>
                    <a href="/index.php/Personal/couponList.html">更多 ></a>
                </div>
                <ul>
                    <?php if(empty($couponOfferList)): ?><li style="font-size: 0.5rem;text-align: center;padding: 0 0.5rem;">亲，您暂时还没优惠券,赶快去<a href="/index.php/Organization/index.html" style="font-size: 0.5rem;text-decoration: underline;">机构列表页</a>点击对应的机构领取吧！</li>
                        <?php else: ?>
                        <?php if(is_array($couponOfferList)): $i = 0; $__LIST__ = array_slice($couponOfferList,0,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($val['coupon_type'] == 1): ?><li class="coupon" <?php if($val['type'] == 1): ?>onclick="getOrgId(<?php echo ($val['type_id']); ?>)"<?php else: ?>onclick="getProduct()"<?php endif; ?>>
                                    <div class="content ">
                                        <div class="texts">
                                            <span>￥<strong><?php echo ($val['subtract']); ?></strong></span>
                                            <div>
                                                <span>优惠券</span>
                                                <p>满<?php echo ($val['full']); ?>元使用</p>
                                                <p>优培圈平台购买商品、课程使用。</p>
                                            </div>
                                        </div>
                                        <div class="hr"></div>
                                        <p>有效期<?php echo ($val['start_time']); ?>-<?php echo ($val['end_time']); ?></p>
                                    </div>
                                    <div class="img">
                                        <img src="../../../../Public/images/imgTap.png" alt="" class="imgTap">
                                        <img src="<?php echo ($val['logo']); ?>" alt="" class="imgLogo">
                                    </div>
                                </li>
                                <?php else: ?>
                                <li class="cash_coupon" <?php if($val['type'] == 1): ?>onclick="getOrgId(<?php echo ($val['type_id']); ?>)"<?php else: ?>onclick="getProduct()"<?php endif; ?>>
                                    <div class="content">
                                        <div class="texts">
                                            <span>￥<strong><?php echo ($val['fee']); ?></strong></span>
                                            <div>
                                                <span>代金券</span>
                                                <p>优培圈平台购买商品、课程使用。</p>
                                            </div>
            ...
            <section class="myPrice">
                <div class="title">
                    <img src="../../../../Public/images/myPrice.png" alt="">
                    <span>我的钱包</span>
                    <!-- <a href="javascript:void(0);">更多 ></a> -->
                </div>
                <ul>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="../../../../Public/images/1496305730.png" alt="">
                            <span>充值</span>
                        </a>                       
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="../../../../Public/images/1496305777.png" alt="">
                            <span>提现</span>
                            <label>余额：<?php echo ((isset($user['money']) && ($user['money'] !== ""))?($user['money']): 0); ?></label>
                        </a>    
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="../../../../Public/images/1496305783.png" alt="">
                            <span>历史记录</span>
                        </a>
                    </li>
                </ul>
            ...
            <section class="myOrder">
                <div class="title">
                    <img src="../../../../Public/images/myOrder.png" alt="">
                    <span>我的订单</span>
                    <a href="/index.php/Orders/allOrders.html">全部订单</a>
                </div>
                <div class="panel">
                    <a href="/index.php/Orders/queryPayByPage.html"><span class="btn" data-icon="Ĥ"><label>待付款<br>(<?php echo ($needPayCount); ?>)个</label></span></a>
                    <a href="/index.php/Orders/queryDeliveryByPage.html"><span class="btn" data-icon="Ģ"><label>待收货</label></span></a>
                    <a href="/index.php/Orders/needCommentList.html"><span class="btn" data-icon="İ"><label>待评价</label></span></a>
                    <a href="/index.php/Orders/queryCancelOrders.html"><span class="btn" data-icon="ɡ"><label>退换/售后</label></span></a>
                </div>
            </section>
            <section class="mine">
                <div class="title">
                    <img src="../../../../Public/images/mine.png" alt="">
                    <span>我的优培</span>
                    <!-- <a href="javascript:void(0);">更多 ></a>  -->
                </div>
                <ul>
                    <li>
                        <a href="/index.php/personal/schedule.html">
                            <img src="../../../../Public/images/course.png" alt="">
                            <span>课程表</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Collect/index');?>">
                            <img src="../../../../Public/images/personalIcon2.png" alt="">
                            <span>收藏</span>
                        </a>    
                    </li>
                    <li>
                        <a href="javascript:void(0);" onclick="getGamesPrize()">
                            <img src="../../../../Public/images/personalIcon3.png" alt="">
                            <span>活动奖品</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Message/index');?>">
                            <img src="../../../../Public/images/personalIcon4.png" alt="">
                            <span>消息</span>
                            <?php if($sum == 0): else: ?><span class="item-new"><?php echo ($sum); ?></span><?php endif; ?>
                        </a>
                    </li>
                    <li>
                        <a href="/index.php/personal/personalData.html">
                            <img src="../../../../Public/images/personalIcon5.png" alt="">
                            <span>个人资料</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" onclick="hint()">
                            <img src="../../../../Public/images/personalIcon1.png" alt="">
                            <span>足迹</span>
                        </a>                       
                    </li>
                </ul>
            </section>
            <section class="info">粤ICP备17008351号</section>
            <section class="tellBox">
                <div class="tellContent">
                    <img src="../../../../Public/images/close.png" alt="" class="closeBtn">
                    <h3>温馨提示</h3>
                    <div class="text">
                        <p>1.完成“我的任务”栏目中的签到可获得5积分；</p>
                        <p>2.完成“我的任务”栏目中的转发文章可获得5积分；</p>
                        <p>3.完成“我的任务”栏目中的发表文章评论可获得5积分；</p>
                        <p>4.完成“我的任务”栏目中的发展学友可获得15积分；</p>
                        <p>5.完成“我的任务”栏目中的阅读3篇未阅读过的文章可获得15积分。</p>
                        <p>6.完成“我的任务”栏目中的完善个人资料可获得20积分（仅第一次填完整有效）。</p>
                    </div>
                </div>
            </section>
            <section class="tellBoxs">
                <div class="tellContents">
                    <img src="../../../../Public/images/close.png" alt="" class="closeBtn">
                    <h3>温馨提示</h3>
                    <div class="text">
                        转发平台的文章到您的朋友或朋友圈，当您的朋友点击进去阅读，那么他（她）就成为了您的学友了。对，就是如此简单，多多转发文章吧，让更多的人成为您的学友。
                    </div>
                </div>
            </section>
        </article>
            ...
            <ul class="icon">
                <li>
                    ...
                    <a href="/index.php/Index/index.html">
                        <img src="/Public/image/footer_icon1.png"/>
                        <span>首页</span>
                    </a>
                </li>
                <li>
                    <img src="/Public/image/circle.png" alt="">
                    <a href="<?php echo U('Discovery/index',array('current'=>'2'));?>">
                        <img src="/Public/image/footer_icon2.png"/>
                        <span>发现</span>
                    </a>
                </li>
                <li>
                    <img src="/Public/image/circle.png" alt="">
                    <a href="/index.php/Association/index/current/3.html">
                        <img src="/Public/image/footer_icon3.png"/>
                        <span>社群</span>
                    </a>
                </li>
                <li>
                    <img src="/Public/image/circle.png" alt="">
                    <a href="<?php echo U('Personal/index',array('current'=>'4'));?>">
                        <img src="/Public/image/footer_icon4.png"/>
                        <span>个人中心</span>
                    </a>
                </li>
            </ul>
        ...
        <script src="/Public/Home/js/jquery.touchSwipe.min.js" type="text/javascript" charset="utf-8"></script>
        <script src="/Public/Home/js/pageloadered.js" type="text/javascript" charset="utf-8"></script>
        <script src="/Public/js/home/font.js" type="text/javascript" charset="utf-8"></script>
        ...
        <script type="text/javascript" src="/Public/js/home/swiper.min.js" ></script>
        <script type="text/javascript" src="/Public/js/home/personalIndex.js" ></script>
    </body>
</html>
